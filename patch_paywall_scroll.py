...
# Hapus LayoutBuilder, SingleChildScrollView, ConstrainedBox bawaan
# Dan buat agar List Plan saja yang scrollable
old_build = re.search(r'  @override\n  Widget build\(BuildContext context\) \{\n    return LayoutBuilder\([\s\S]*?      \},.*?    \);\n  \}', code)
if old_build:
    new_build = """  @override
  Widget build(BuildContext context) {
    return Padding(
    ...
    code = code[:old_build.start()] + new_build + code[old_build.end():]
